...
- Aim to keep files between 100-500 loc; if a file exceeds 500 loc, refactor into smaller files
                ...
                async for message in client.receive_messages():
                    ...
                    if session_message_count >= config.max_agent_messages:
                        ...
                        await client.query(
                            ...
                            "   - First, delete any scratch files you created (.hol_cmd.sml, *~, *.swp, etc.) "
                            ...
                            "   - NEVER commit: *.uo, *.ui, .hol_cmd.sml, .agent_* "
